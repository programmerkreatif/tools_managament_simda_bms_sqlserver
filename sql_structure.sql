...
CREATE TABLE [dbo].[Ref_Desa] (
	...
	CONSTRAINT [PK_Ref_Desa] PRIMARY KEY ([Kd_Prov], [Kd_Kab_Kota], [Kd_Kecamatan], [Kd_Desa])
);
...
CREATE TABLE [dbo].[Ref_Kab_Kota] (
	...
	CONSTRAINT [PK_Ref_Kab_Kota] PRIMARY KEY ([Kd_Prov], [Kd_Kab_Kota])
);
...
CREATE TABLE [dbo].[Ref_S_Bidang] (
	...
	CONSTRAINT [PK_Ref_S_Bidang] PRIMARY KEY ([Kd_Urusan], [Kd_Bidang])
);
